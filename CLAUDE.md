# Recipe-Scrape — Food52 Catalog Builder
...
# Re-process without re-scraping (reuses output/recipe_urls.json)
...
| File | Description |
|------|-------------|
| `output/recipe_urls.json` | Phase 1 result — URL list with meal_type/dietary tags |
...
- Rate limit: 1–2 s random delay between every request (`_http.py`)
